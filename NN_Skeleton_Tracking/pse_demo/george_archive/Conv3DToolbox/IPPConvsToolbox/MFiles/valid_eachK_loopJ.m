%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%>
% This is a backward compatibility file for doing the valid_each3_sum4 operation.
% DO NOT USE THIS FUNCTION if coding up new software, use the newer valid_each3_sum4.m
% @copybrief valid_each3_sum4.m
% @see valid_each3_sum4.m for full documentation and usage.
%
% @deprecated Use valid_each3_sum4.m instead.
% @file
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [out] = valid_eachK_loopJ(maps,F,C,COMP_THREADS)
out = valid_each3_sum4(maps,F,C,COMP_THREADS);
end
