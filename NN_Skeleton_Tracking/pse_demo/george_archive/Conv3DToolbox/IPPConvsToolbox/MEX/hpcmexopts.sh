...
#----------------------------------------------------------------------------
            ...
            CC='/share/apps/intel/cce/10.0.023/bin/icc'
            ...
            CDEBUGFLAGS='-g'
#           
            CXX='/share/apps/intel/cce/10.0.023/bin/icc'
...
# note that cce is the 64-bit version and cc is the 32-bit version
            RPATH="-Wl,-rpath-link,$TMW_ROOT/bin/$Arch"
            CC='/share/apps/intel/Compiler/11.1/046/bin/intel64/icc'
            CFLAGS='-ansi -D_GNU_SOURCE -fexceptions'
            ...
            CDEBUGFLAGS='-g'
#
            CXX='/share/apps/intel/Compiler/11.1/046/bin/intel64/icc'
