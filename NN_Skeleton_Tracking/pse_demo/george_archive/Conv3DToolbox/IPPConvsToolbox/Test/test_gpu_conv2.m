%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%>
% A test script for gpu_conv2.m, valid_eachK_loopJ_gpu.m, valid_loopK_loopJ_gpu.m
% and full_eachJ_loopK_gpu.m which compares speed for different types of 
...
% tCPU =tic;
% R = valid_eachK_loopJ(maps,F,C,4);
% tC=toc(tCPU);
% fprintf('CPU time for valid_eachK_loopJ: %f\n',tC);
% fprintf('Computing on GPU\n');
% tGPU=tic; gR = valid_eachK_loopJ(gmaps,gF,gC,4); GPUsync; t=toc(tGPU);
% fprintf('GPU time for valid_eachK_loopJ: %f, Speedup: %f\n',t,tC/t);
...
% % profile on
% tGPU = tic; 
% gR = valid_eachK_loopJ(gmaps,gF,gC,4);
%  GPUsync; t=toc(tGPU);
% % profile viewer
% fprintf('GPU time for valid_eachK_loopJ: %f, Speedup: %f\n',t,tC/t);
% fprintf('Maximum Error: %f\n',max(abs(R(:)-single(gR(:)))));
...
% clear all
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 Images, Different Filters\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(156,156,16,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,1,16,64,'single');
% gF  =GPUsingle(F);
% C = ones(1,16,'single');
% gC = GPUsingle(C);
% fprintf('Computing on CPU\n');
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 4 Parameters 64 Images, Different Filters\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(15,15,150,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,100,150,64,'single');
% gF  =GPUsingle(F);
% C = ones(100,150,'single');
% gC = GPUsingle(C);
% fprintf('Computing on CPU\n');
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 Images Sparse Connectivity\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(156,156,16,64,'single');
% gmaps = GPUsingle(maps);
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 4 Parameters 64 Images Sparse Connectivity\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(15,15,150,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,100,150,'single');
% gF  =GPUsingle(F);
...
% % % % % % % % 
% % % % % % % % % fprintf('XXXXXXXXXXXXXXXXXXXXXX\nPermuted Layer 1 Parameters 64 Images\nXXXXXXXXXXXXXXXXXXXXXX\n')
% % % % % % % % % maps = randn(156,156,15,64,'single');
...
gC = GPUsingle(C);
fprintf('Computing on CPU\n');
tic;R = valid_loopK_loopJ(maps,F,C,4);tC=toc;
fprintf('CPU time for valid_loopK_loopJ: %f\n',tC);
fprintf('Computing on GPU\n');
% gprofile on
tic; gR = valid_loopK_loopJ(gmaps,gF,gC,4); GPUsync; t=toc;
% gprofile report
fprintf('GPU time for valid_loopK_loopJ: %f, Speedup: %f\n',t,tC/t);
% figure(1), sdf(R);
% figure(2), sdf(single(gR));
fprintf('Maximum Error: %f\n\n',max(abs(R(:)-single(gR(:)))));
% fprintf('Memory Free: %f\n',GPUmem)
...
fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 images\nXXXXXXXXXXXXXXXXXXXXXX\n')
maps = ones(156,156,15,64,'single');
gmaps = GPUsingle(maps);
F = randn(150,150,3,64,'single');
gF  =GPUsingle(F);
C = ones(3,15,'single');
gC = GPUsingle(C);
fprintf('Computing on CPU\n');
...
fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 images, Sparse Connectivity\nXXXXXXXXXXXXXXXXXXXXXX\n')
maps = ones(156,156,15,10,'single');
gmaps = GPUsingle(maps);
F = randn(150,150,3,10,'single');
gF  =GPUsingle(F);
% C = ones(3,15,'single');
...
% fprintf('Computing on CPU\n');
% tic;
% R = full_eachJ_loopK(maps,F,C,4);
% tC=toc;
% fprintf('CPU time for full_eachJ_loopK: %f\n',tC);
% fprintf('Computing on GPU\n');
% tic; gR = full_eachJ_loopK(gmaps,gF,gC,4); GPUsync; t=toc;
% % figure(1), sdf(R);
% % figure(2), sdf(single(gR));
...
% gC = GPUsingle(C);
% fprintf('Computing on CPU\n');
% tic; R = full_eachJ_loopK(maps,F,C,4);tC=toc;
% fprintf('CPU time for full_eachJ_loopK: %f\n',tC);
% fprintf('Computing on GPU\n');
% tic; gR = full_eachJ_loopK(gmaps,gF,gC,4); GPUsync; t=toc;
% fprintf('GPU time for full_eachJ_loopk: %f, Speedup: %f\n',t,tC/t);
...
% clear all
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 Images, Same Filters\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(150,150,3,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,3,16,'single');
% gF  =GPUsingle(F);
% C = ones(3,16,'single');
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 4 Parameters 64 Images, Same Filters\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(7,7,50,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,50,150,'single');
% gF  =GPUsingle(F);
% C = ones(50,150,'single');
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 1 Parameters 64 Images, Same Filters, Sparse Conmats\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(150,150,3,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,3,16,'single');
% gF  =GPUsingle(F);
...
% 
% 
% fprintf('XXXXXXXXXXXXXXXXXXXXXX\nLayer 4 Parameters 64 Images, Same Filters, Sparse Conmats\nXXXXXXXXXXXXXXXXXXXXXX\n')
% maps = randn(7,7,50,64,'single');
% gmaps = GPUsingle(maps);
% F = randn(7,7,50,150,'single');
% gF  =GPUsingle(F);
