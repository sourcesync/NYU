...
if(nvmex) % Compile using nvmex.
    ...
    if (make_cpp)
        ...
        infiles = {};
        infiles{end+1} = ['cuAvgPool.cpp ' common ];
        infiles{end+1} = ['cuRevAvgPool.cpp ' common ];
        infiles{end+1} = ['cuAvgPool3d.cpp ' common ];
        infiles{end+1} = ['cuRevAvgPool3d.cpp ' common ];
...
% 
%       filesfilters = {['max.' mexext],['max.m'],['min.' mexext],['min.m']};
