...
//         CUresult status = cuModuleGetFunction(&drvfunf, *drvmod, "MAXPOOLF");
        CUresult status = cuModuleGetFunction(&drvfunfunp, *drvmod,  "REVAVGPOOLF3D");
...
//         mexPrintf("Unpooled size is passed in\n");
        ...
        numunpdims = mxGetNumberOfDimensions(prhs[2]);
...
//     mexPrintf("unpdims: %d, nin1: %d, out_size: %f x %f x %f x %d\n", unpdims[1], nin1, unpsize[0], unpsize[1],unpsize[2],out_size[3]);
