...
__host__ void dummyTemplateInstantiator(void){
  ...
  conv_bw_nofit_4x16_2per<true,1><<<0,0,0>>>(0,0,0,0,0);
  conv_bw_nofit_4x16_2per<true,3><<<0,0,0>>>(0,0,0,0,0);
  conv_bw_nofit_4x16_2per<false,1><<<0,0,0>>>(0,0,0,0,0);
  conv_bw_nofit_4x16_2per<false,3><<<0,0,0>>>(0,0,0,0,0);

  conv_bw_fit_4x16_1per<15,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<15,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<15,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<15,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_1per<16,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<16,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<16,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<16,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_1per<17,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<17,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<17,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<17,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_1per<18,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<18,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<18,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<18,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_1per<19,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<19,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<19,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<19,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_1per<20,true,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<20,true,3><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<20,false,1><<<0,0,0>>>(0, 0, 0, 0);
  conv_bw_fit_4x16_1per<20,false,3><<<0,0,0>>>(0, 0, 0, 0);

  conv_bw_fit_4x16_2per<2,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<2,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<2,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<2,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<3,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<3,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<3,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<3,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<4,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<4,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<4,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<4,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<5,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<5,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<5,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<5,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<6,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<6,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<6,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<6,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<7,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<7,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<7,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<7,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<8,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<8,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<8,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<8,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<9,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<9,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<9,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<9,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<10,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<10,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<10,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<10,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<11,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<11,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<11,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<11,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<12,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<12,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<12,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<12,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<13,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<13,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<13,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<13,false,3><<<0,0,0>>>(0,0,0,0);

  conv_bw_fit_4x16_2per<14,true,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<14,true,3><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<14,false,1><<<0,0,0>>>(0,0,0,0);
  conv_bw_fit_4x16_2per<14,false,3><<<0,0,0>>>(0,0,0,0);
