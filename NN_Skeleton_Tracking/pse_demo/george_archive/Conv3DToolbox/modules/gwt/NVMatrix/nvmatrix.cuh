...
public:
  ...
  //bool resize(const Matrix &like);
    ...
    void aggregate2(int axis, NVMatrix& target, NVMatrix& argmax, int numThreadsPerBlock, NVMatrix::AGGREGATIONS agg);
    void aggregate3(int axis, NVMatrix& target, NVMatrix& argmax, int numThreadsPerBlock, NVMatrix::AGGREGATIONS agg);
    void sum(int axis, NVMatrix& target);
    NVMatrix& sum(int axis);
    float sum();
    void max(int axis, NVMatrix& target);
    void max2(int axis, NVMatrix& target, NVMatrix& argmax);
    void max3(int axis, NVMatrix& target, NVMatrix& argmax);
